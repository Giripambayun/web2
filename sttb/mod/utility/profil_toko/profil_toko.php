        ...
        <table class="form">
		  <tr><div class="form-group">
            ...
            <td><input type="hidden" name="id_toko" value="<?php print $y['id_toko']; ?>">
                <input type="text" class="form-control" name="nama" id="nama" value="<?php print $y['nama']; ?>" size="41px" />
            </td>
              </div>
          </tr>
          <tr>
            ...
            <td>Alamat Toko</td>
            <td>:</td>
            <td><textarea name="alamat" class="form-control" id="alamat"><?php print $y['alamat']; ?></textarea></td>
              </div>
          </tr>
		  <tr>
            <td>No. Telpon</td>
            <td>:</td>
            <td><input type="text" class="form-control" name="telp" id="telp" value="<?php print $y['telp']; ?>" size="20px" /></td>
          </tr>
	      <tr>
            <td>Email</td>
            <td>:</td>
            <td><input type="text" class="form-control" name="email" id="email" value="<?php print $y['email']; ?>" size="20px" /></td>
          </tr>
          <tr>
            <td>Keterangan</td>
            <td>:</td>
            <td><textarea name="keterangan" class="form-control" id="keterangan"><?php print $y['keterangan']; ?></textarea></td>
          </tr>
          <tr>
            <td></td>
            <td></td>
